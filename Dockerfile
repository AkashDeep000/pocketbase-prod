...
# Download Pocketbase and install it for ARM64
ADD https://github.com/pocketbase/pocketbase/releases/download/v${POCKETBASE_VERSION}/pocketbase_${POCKETBASE_VERSION}_linux_arm64.zip /tmp/pocketbase.zip
